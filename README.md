...
The column is a meter with a middle. Up is surplus, down is draw, and one setting decides which boundary it watches:
...
| `ring.meter_style` | `blocks` | Stepped blocks or one continuous bar. |
