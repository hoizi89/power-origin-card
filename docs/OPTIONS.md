...
| `ring.flow_gauges` | `true` | In the flow, each circle a gauge: PV against today's peak, the battery by its charge, the grid against today's most in that direction, the house by where its power comes from. |
